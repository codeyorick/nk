    ...
    <Card.Root>
      ...
      <Card.Content class="space-y-4">
        ...
        <div class="space-y-2">
          ...
          <Textarea id="description" name="description" placeholder="Describe your event..." value={form?.values?.description ?? ""} />
        </div>

        <div class="grid grid-cols-2 gap-4">
          <div class="space-y-2">
            <Label for="startDate">Start Date</Label>
            <Input id="startDate" name="startDate" type="datetime-local" value={form?.values?.startDate ?? ""} />
          </div>
          <div class="space-y-2">
            <Label for="endDate">End Date</Label>
            <Input id="endDate" name="endDate" type="datetime-local" value={form?.values?.endDate ?? ""} />
          </div>
        </div>
